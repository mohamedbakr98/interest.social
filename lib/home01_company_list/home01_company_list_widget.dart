...
class Home01CompanyListWidget extends StatefulWidget {
  const Home01CompanyListWidget({super.key});

  @override
  State<Home01CompanyListWidget> createState() =>
      _Home01CompanyListWidgetState();
}

class _Home01CompanyListWidgetState extends State<Home01CompanyListWidget>
    with TickerProviderStateMixin {
  late Home01CompanyListModel _model;
