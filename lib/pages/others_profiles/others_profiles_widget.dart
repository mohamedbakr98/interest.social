...
import 'others_profiles_model.dart';
export 'others_profiles_model.dart';

class OthersProfilesWidget extends StatefulWidget {
  const OthersProfilesWidget({super.key});

  @override
  State<OthersProfilesWidget> createState() => _OthersProfilesWidgetState();
}

class _OthersProfilesWidgetState extends State<OthersProfilesWidget> {
  late OthersProfilesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OthersProfilesModel());
