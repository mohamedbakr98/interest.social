...
import 'choose_card_genre_model.dart';
export 'choose_card_genre_model.dart';

class ChooseCardGenreWidget extends StatefulWidget {
  const ChooseCardGenreWidget({super.key});

  @override
  State<ChooseCardGenreWidget> createState() => _ChooseCardGenreWidgetState();
}

class _ChooseCardGenreWidgetState extends State<ChooseCardGenreWidget> {
  late ChooseCardGenreModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChooseCardGenreModel());
