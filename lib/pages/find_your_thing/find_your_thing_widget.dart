...
import 'find_your_thing_model.dart';
export 'find_your_thing_model.dart';

class FindYourThingWidget extends StatefulWidget {
  const FindYourThingWidget({super.key});

  @override
  State<FindYourThingWidget> createState() => _FindYourThingWidgetState();
}

class _FindYourThingWidgetState extends State<FindYourThingWidget> {
  late FindYourThingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FindYourThingModel());
